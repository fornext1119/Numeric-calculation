...
begin
	...
	while y(0) >= 0.0 loop
        ...
        x(0)  := x(0)  + ( x(1) +  x(2) * 2.0 +  x(3) * 2.0 +  x(4)) / 6.0;
        y(0)  := y(0)  + ( y(1) +  y(2) * 2.0 +  y(3) * 2.0 +  y(4)) / 6.0;
        vx(0) := vx(0) + (vx(1) + vx(2) * 2.0 + vx(3) * 2.0 + vx(4)) / 6.0;
        vy(0) := vy(0) + (vy(1) + vy(2) * 2.0 + vy(3) * 2.0 + vy(4)) / 6.0;
